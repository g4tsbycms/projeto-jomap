async function requestExternalImage(imageUrl) {
  ...
  try {
    ...
    throw new Error('falha ao carregar a imagem pela url: ' + imageUrl)
  }
}
...
function renderNavBar(navbarId, exampleUri) {
  const examples = [
    {
      uri: 'face_detection',
      name: 'Projeto-JOMAP - Detecção Facial'
    },
    {
      uri: 'face_landmark_detection',
      name: 'Ponto de referência facial'
    },
    {
      uri: 'face_expression_recognition',
      name: 'Reconhecimento de expressão facial'
    },
    {
      uri: 'age_and_gender_recognition',
      name: 'Reconhecimento de Idade e Sexo'
    },
    {
    ...
    {
      uri: 'face_extraction',
      name: 'Extração facial'
    },
    {
      uri: 'video_face_tracking',
      name: 'Rastreamento de rosto em vídeo'
    },
    {
      uri: 'webcam_face_detection',
      name: 'Detecção de Rosto por Webcam'
    },
    {
      uri: 'webcam_face_landmark_detection',
      name: 'Webcam - Ponto de referência facial por webcam'
    },
    {
      uri: 'webcam_face_expression_recognition',
      name: 'Webcam - Reconhecimento de expressão facial'
    },
    {
      uri: 'webcam_age_and_gender_recognition',
      name: 'Webcam-Idade e reconhecimento de gênero'
    },
    {
      uri: 'bbt_face_landmark_detection',
      name: 'Detecção de ponto de referência facial'
    },
    {
      uri: 'bbt_face_similarity',
      name: 'Semelhança facial'
    },
    {
      uri: 'bbt_face_matching',
      name: 'Coincidindo Rosto'
    },
    {
    ...
    },
    {
      ...
      name: 'Detecção de marco facial em massa'
    },
    {
      uri: 'batch_face_recognition',
      name: 'Reconhecimento facial em massa'
    }
  ]
